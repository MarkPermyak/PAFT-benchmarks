...
class HyFd(object):
    def __init__(self, data_csv_path, args):
        self.natts = 0
        self.nrecs = 0
        self.data_path = f'{args.db_path}/{data_csv_path}' 
        t0 = time.time()
        self.records = read_csv(self.data_path, separator=args.separator)
        ...
        self.stat_directory = args.curr_folder_path + '/results/'
        self.output_directory = args.curr_folder_path + '/json/'

        self.row_checks = 0

        self.go_on = True
        
        self.output = Output(logging, self.data_path, output_directory=self.output_directory)
        log_headers = [
            'Database',
            'Path',
            'Timestamp',
        ...
        self.stats = Stats(logging, log_headers, args.restart, stat_directory=self.stat_directory)
